% == Radar parameters D ==
% This file contains all radar parameters for configuration "D".
...
num_frames = 4000; % number of frames = number of chirps
T_f = 5*1e-3; % frame periodicity in mmWave Studio
